...
messages["voice_commands"] = ("Попробуй послать боту команду в виде голосового.\n"
                              ...
                              "Бот попытается распознать команду и выполнит ее в случае успешного распознования.\n\n"
                              "⚠️ Распознование производится при помощи Carnegie Mellon University's open-source "
